...
from src.graph.nodes import supervisor_node, search_profile_node, get_profile_detail_node
...
async def init_root_graph():
    ...
    builder.add_node(config_agents.PROFILE_GRAPH.AGENT_SEARCH_PROFILE, search_profile_node)
    builder.add_node(config_agents.PROFILE_GRAPH.AGENT_GET_PROFILE_DETAIL, get_profile_detail_node)
